package com.dodopal.account.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.account.business.*.*.*(..)) || execution(public * com.dodopal.account.web.controller.*.*.*(..)) || execution(public * com.dodopal.account.delegate.*.*.*(..))")
