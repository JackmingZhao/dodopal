...
public class ProductOrder extends BaseEntity {
    ...
    // 实付（收）金额：商户支付给DDP的金额（一般从账户里扣）。在UI设计的时候，展现给商户的页面叫做：实付金额；running内展示为：实收金额。在正常情况下，这个跟“商户进货价”的数据相同。但是如果有针对商户进行促销活动的时候，这个价格可能低于“商户进货价”。
