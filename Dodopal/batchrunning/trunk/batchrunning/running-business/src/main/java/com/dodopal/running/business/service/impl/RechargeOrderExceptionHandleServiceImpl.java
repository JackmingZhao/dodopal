...
import com.dodopal.common.enums.ICDCOrderStatusEnum;
...
import com.dodopal.running.business.dao.LoadOrderMapper;
import com.dodopal.running.business.dao.PayTraTransactionMapper;
import com.dodopal.running.business.dao.ProductOrderMapper;
...
import com.dodopal.running.business.model.ExceptionOrderHandleDto;
...
public class RechargeOrderExceptionHandleServiceImpl implements RechargeOrderExceptionHandleService {
    ...
    public DodopalResponse<String> accountUnfreezeHandle(ProductOrder productOrder, String operatorName) {
        ...
        if (LoadFlagEnum.LOAD_YES.getCode().equals(productOrder.getLoadFlag())) {
            ...
            if (StringUtils.isNotBlank(productOrder.getLoadOrderNum())) {
                loadOrderMapper.updateLoadOrderStatus(ICDCOrderStatusEnum.ORDER_FAILURE.getCode(), productOrder.getLoadOrderNum(), operatorName); 
            }
            ...
            for (AccountChange oldAccountChange : oldAccountChangeList) {
                ...
                if (FundTypeEnum.FUND.getCode().equals(oldAccountChange.getFundType())) {
                    ...
                    if (newAvailableAmt > RunningConstants.TOTALBALANCE_MAX) {
    ...
    public DodopalResponse<String> accountDeductHandle(ProductOrder productOrder, String operatorName) {
        ...
        if (LoadFlagEnum.LOAD_YES.getCode().equals(productOrder.getLoadFlag())) {
            ...
            if (StringUtils.isNotBlank(productOrder.getLoadOrderNum())) {
                loadOrderMapper.updateLoadOrderStatus(ICDCOrderStatusEnum.CHARGE_SUCCESS.getCode(), productOrder.getLoadOrderNum(), operatorName); 
            }
