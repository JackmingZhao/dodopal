...
import com.dodopal.running.business.model.PayTransaction;
import com.dodopal.running.business.model.ProductOrder;
import com.dodopal.running.business.model.Purchase;
...
public class ClearingTask {
    ...
    private DDPLog<ClearingTask> ddpLog = new DDPLog<ClearingTask>(ClearingTask.class);
    @Autowired
