...
//			}
    ...
    /**
     * 对象转为Map<String,String>,为签名做准备
     * @param obj 
     * @return 响应码 转换后的map
     */
    public static DodopalResponse<Map<String,String>> getSignMap(Object obj) {  
    	DodopalResponse<Map<String,String>> res = new DodopalResponse<Map<String,String>>();
    	...
    	Map<String, String>  mp =  new  HashMap<String, String>();
    	 try {
	    	...
	    	for (PropertyDescriptor pd:pds) {
			   ...
			   if(!name.equals("class")){    		
				   ...
				   if(PropertyUtils.getProperty(obj, name)!=null){
					   //取得对象属性对应的值
					   String value = PropertyUtils.getProperty(obj, name).toString();
					   mp.put(name, value);
				   }    				  
			   }
	    	}
			...
			e.printStackTrace();
			res.setCode(ResponseCode.SIGN_ERROE);
    ...
    public static Map<String, String> removeNull(Map<String, String> sArray) {
        ...
        for (String key : sArray.keySet()) {
            String value = sArray.get(key);
            if (value == null || value.equals("") || key.equalsIgnoreCase("sign")
                    || key.equalsIgnoreCase("sign_type") || key.equalsIgnoreCase("genId")) {
                continue;
            }
            result.put(key, value);
        }
     ...
     * @return 签名结果
     */
    public static String signCom(String text, String input_charset) {
    	return DigestUtils.md5Hex(getContentBytes(text, input_charset));
    }    
