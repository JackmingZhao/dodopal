package com.dodopal.logservice.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.logservice.business.*.*.*(..)) || execution(public * com.dodopal.logservice.web.controller.*.*.*(..)) || execution(public * com.dodopal.logservice.delegate.*.*.*(..))")
