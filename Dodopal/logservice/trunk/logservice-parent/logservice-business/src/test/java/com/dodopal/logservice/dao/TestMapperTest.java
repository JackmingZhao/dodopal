package com.dodopal.logservice.dao;
...
import com.dodopal.logservice.business.dao.TestMapper;
...
//    @Test
    public void testFindTest() {
        try {
            ...
            test.setName("123");
            test.setAppName("logservice");
            test.setDescription("Junit test");
            List<com.dodopal.logservice.business.model.Test> testResult = testMapper.findTest(test);
...
//    @Test
    public void testFindTestById() {
        try {
            com.dodopal.logservice.business.model.Test testResult = testMapper.findTestById("22");
