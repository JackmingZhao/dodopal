package com.dodopal.merdevice.business.log;
...
//
//    @Pointcut("execution(public * com.dodopal.merdevice.business.*.*.*(..)) || execution(public * com.dodopal.merdevice.web.controller.*.*.*(..)) || execution(public * com.dodopal.merdevice.delegate.*.*.*(..))")
