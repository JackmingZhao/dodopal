package com.dodopal.merdevice.dao;
...
import com.dodopal.merdevice.business.dao.TestMapper;
...
//    @Test
    public void testFindTest() {
        try {
            com.dodopal.merdevice.business.model.Test test = new com.dodopal.merdevice.business.model.Test();
            test.setName("123");
            test.setAppName("merdevice");
            test.setDescription("Junit test");
            List<com.dodopal.merdevice.business.model.Test> testResult = testMapper.findTest(test);

            if (testResult != null) {
                System.out.println("##########################################");
                System.out.println(ReflectionToStringBuilder.toString(testResult, ToStringStyle.MULTI_LINE_STYLE));
                System.out.println("##########################################");
                for (com.dodopal.merdevice.business.model.Test dp : testResult) {
                    System.out.println("##########################################");
...
//    @Test
    public void testFindTestById() {
        try {
            com.dodopal.merdevice.business.model.Test testResult = testMapper.findTestById("22");
