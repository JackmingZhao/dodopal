...
public class LoadOrderBean extends BaseEntity {
    private static final long serialVersionUID = -9176920727101351735L;
    ...
    public String getLoadAmtView(){
        return String.valueOf((double)loadAmt/100);
    }
    
    public String getOrderStatusStr() {
        LoadOrderStatusEnum statusEnum = LoadOrderStatusEnum.parseByCode(status);
        if(statusEnum != null) {
    ...
    public String getCustomerTypeView(){
        if (StringUtils.isNotBlank(getCustomerType()))
           return MerUserTypeEnum.getMerUserTypeNameByCode(getCustomerType());
        return "";
    }
}
