...
public class PayAwayBean extends BaseEntity{

    /**
     * 
     */
    private static final long serialVersionUID = -548724784386039429L;
    /**
     * 商户名称
     */
    ...
    public String getBankGateWayTypeView() {
    	
    	 if (StringUtils.isBlank(this.bankGateWayType)) {
             return null;
         }else if(BankGatewayTypeEnum.getBankGatewayTypeByCode(this.bankGateWayType)==null){
             return null;
         }
         return BankGatewayTypeEnum.getBankGatewayTypeByCode(this.bankGateWayType).getName();
    }
