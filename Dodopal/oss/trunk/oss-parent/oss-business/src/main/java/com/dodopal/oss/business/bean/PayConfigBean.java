 ...
 */
public class PayConfigBean extends BaseEntity  {
    
    private static final long serialVersionUID = 1668949610137903870L;
...
//        if(null!=bankGatewayType){
//            return BankGatewayTypeEnum.getBankGatewayTypeByCode(bankGatewayType).getName();
//        }
//        return "";
//    }
