 ...
 *
 */
public class ProductYktLimitBatchInfoBean extends BaseEntity{
    ...
    public String getAuditStateView() {
        ...
        String auditStateView="";
        if (StringUtils.isNotBlank(this.auditState)) {
            auditStateView = AuditStateEnum.getAuditStateNameByCode(this.auditState);
        }
        
        return auditStateView;
    }
    
    public String getCheckStateView() {
        
        String checkStateView="";
        if (StringUtils.isNotBlank(this.checkState)) {
            checkStateView = CheckStateEnum.getCheckStateNameByCode(this.checkState);
        }
    ...
    public Long getFinancialPayFee() {
        if (!AuditStateEnum.AUDIT_SUCCESS.getCode().equals(auditState)) {
            financialPayFee = null;
        }
