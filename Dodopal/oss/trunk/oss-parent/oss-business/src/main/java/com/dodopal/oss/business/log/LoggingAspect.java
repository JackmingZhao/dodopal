package com.dodopal.oss.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.oss.business.*.*.*(..)) || execution(public * com.dodopal.oss.web.controller.*.*.*(..)) || execution(public * com.dodopal.oss.delegate.*.*.*(..))")
