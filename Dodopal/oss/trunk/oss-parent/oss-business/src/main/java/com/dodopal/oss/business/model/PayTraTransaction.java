...
public class PayTraTransaction extends BaseEntity  {
    ...
    /**
     * @param merParentCode the merParentCode to set
     */
    ...
    /**
     * @param merParentName the merParentName to set
     */
    ...
    /**
     * @param merCityName the merCityName to set
     */
    ...
    /**
     * @param merPayMoneyUser the merPayMoneyUser to set
     */
