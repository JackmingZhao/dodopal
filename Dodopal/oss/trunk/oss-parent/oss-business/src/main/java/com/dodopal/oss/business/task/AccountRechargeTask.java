...
public class AccountRechargeTask {
    ...
    public void accountRecharge(){
        ...
        // oss系统  admin 的id
        User  user= userMgmtService.findUserByLoginName(OSSConstants.ADMIN_USER);
        ...
        for (PayTraTransaction tran : tranList) {
            ...
            try {
                ...
                ActivemqLogPublisher.publishLog2Queue(log, DodopalAppVarPropsUtil.getStringProp(OSSConstants.SERVER_LOG_NAME), DodopalAppVarPropsUtil.getStringProp(OSSConstants.SERVER_LOG_URL));
            }
