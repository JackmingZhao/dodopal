...
public class Initializer_QA {
    ...
    private void addAdminUser() {
        ...
        user.setPassword(MD5.MD5Encode("dodopal-1qaz2wsx"));
        user.setName("Admin");
    ...
    public static void main(String[] args) throws Exception {
        AbstractXmlApplicationContext context = new ClassPathXmlApplicationContext(new String[] {"oss-business-test-context_qa.xml"});
        context.getBean(Initializer_QA.class).initialize();
    }
