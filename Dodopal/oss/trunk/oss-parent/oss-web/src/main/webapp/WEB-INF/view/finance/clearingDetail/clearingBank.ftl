...
<head>
    ...
    <script type="text/javascript" src="../../../js/finance/clearingDetail/clearingBank.js"></script>
</head>
<body class="easyui-layout" style="overflow: hidden;">
	<div region="north" border="false" style="height:60px;overflow: hidden;">
		<form id="bankForm" action="exportBank" method="post">
	    <table id="queryCondition" class="viewtable">
	        <tr>
	            ...
	            <th></th>
	            <td>
	            	<@sec.accessControl permission="clearingDetailManage.bank.query">
    ...
    <div id="clearingTblToolbar" class="tableToolbar">
    	<@sec.accessControl permission="clearingDetailManage.bank.export">
