...
<head>
    ...
    <script type="text/javascript" src="../../../js/finance/clearingDetail/clearingYkt.js"></script>
</head>
<body class="easyui-layout" style="overflow: hidden;">
	<div region="north" border="false" style="height:60px;overflow: hidden;">
		<form id="yktForm" action="exportYkt" method="post">
	    <table id="queryCondition" class="viewtable">
	        <tr>
	            ...
	            <th></th>
	            <td>
	            	<@sec.accessControl permission="clearingDetailManage.supplier.query">
    ...
    <div id="clearingTblToolbar" class="tableToolbar">
    	<@sec.accessControl permission="clearingDetailManage.supplier.export">
