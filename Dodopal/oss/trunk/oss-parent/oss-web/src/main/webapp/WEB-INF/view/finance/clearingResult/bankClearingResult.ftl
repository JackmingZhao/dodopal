...
<head>
    ...
    <script type="text/javascript" src="../../../js/finance/clearingResult/bankClearingResult.js"></script>
...
<body class="easyui-layout" style="overflow: hidden;">
	<div region="north" border="false" style="height:60px;overflow: hidden;">
		<form id="banklistForm" action="exportBankClearingResult" method="post">  
	    <table id="queryCondition" class="viewtable">
	        <tr>
	            ...
	            <th></th>
	            <td>
	            	<@sec.accessControl permission="clearingResultManage.bank.query">
	                <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="findBankClearingResult(1);">查询</a>
	                </@sec.accessControl>
	                &nbsp;&nbsp;
	...
	<div id="clearingResultTblToolbar" class="tableToolbar">
		<@sec.accessControl permission="clearingResultManage.bank.export">
