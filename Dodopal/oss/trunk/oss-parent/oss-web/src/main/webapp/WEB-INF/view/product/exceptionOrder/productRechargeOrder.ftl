...
<head>
	<title>异常产品库充值订单</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge"/>
	<#include "../../include.ftl"/>
	<script type="text/javascript" src="${scriptUrl}/common/file/jquery.fileDownload.js"></script>
	<script type="text/javascript" src="../../../js/common/exportExceClearing.js"></script>
	<script type="text/javascript" src="../../../js/product/exceptionOrder/productRechargeOrder.js"></script>
</head>
	...
	<div region="north" border="false" style="height:105px;overflow: hidden;">
	    <table id="queryCondition" class="viewtable">
	        <tr>
				...
				<th></th>
                <td>
				<@sec.accessControl permission="exceptionOrder.rechargeOrder.query">
			...
			<tr>
                <th>订单状态:</th>
				<td>
					<select id="proOrderStateQuery" name="proOrderStateQuery" class="easyui-combobox" editable="false" panelHeight="150" style="width: 160px;">
						<option value='' selected>-请选择-</option>
				...
				<th>内部状态:</th>
				<td>
					<select id="proInnerStateQuery" name="proInnerStateQuery" class="easyui-combobox" editable="false" style="width: 133px;">
						<option value='' selected>-请选择-</option>
               ...
               <th>支付类型:</th>
                <td>
                	<select id="payTypeQuery" name="payTypeQuery" class="easyui-combobox" editable="false" panelHeight="110" style="width: 133px;">
						<option value='' selected>-请选择-</option>
	...
	<div id="exceptionHandleDialog" class="easyui-dialog" title="异常处理" style="width:400px;height:200px;" data-options="iconCls:'icon-user',modal:true,closed:true">  
		<div>
			<div id='messageDiv' style="padding:10px;height:60px;">
			    <!-- <label><input  name="activate" type="radio" value="1" />充值成功</label> --> 
				<!-- <label><input  name="activate" type="radio" value="0" />充值失败 </label> --> 
			</div>
			<div id='radioDiv' style="padding:10px;height:20px;display:none">
			    <label><input  name="handleSign" type="radio" value="1" />充值成功（资金扣款）</label> 
				<label><input  name="handleSign" type="radio" value="0" />充值失败 （资金解冻）</label> 
			</div>
		</div> 
