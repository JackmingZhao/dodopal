...
<head>
	...
	<#include "../../include.ftl"/>
    <script type="text/javascript" src="../../js/account/accountInfo/accountPersonInfo.js"></script>
...
<!--             <th>账户类别:</th>
            <td>
            <select type="hidden" id="fundType" name="fundType" editable="false">
