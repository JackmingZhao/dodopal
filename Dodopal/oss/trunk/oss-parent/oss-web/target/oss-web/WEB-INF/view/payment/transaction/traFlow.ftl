...
<head>
	...
	<script type="text/javascript" src="../../js/payment/transaction/traFlow.js"></script>
	<title>OSS交易流水</title>
</head>
...
<body  class="easyui-layout" style="overflow: hidden;">
    ...
    <form id="traForm" action="exportTransaction" method="post">  
		<table id="traQueryCondition" class="viewtable">
			<tr>
				...
				<th></th>
				<td>
					<@sec.accessControl permission="transaction.flow.query">
			...
			<tr>
					<th>业务类型:</th>
					<td>
						<select id="businessTypeQuery" name="businessTypeQuery"  class="easyui-combobox" style="width: 180px;" panelHeight="auto" panelMaxHeight="75" editable="false" panelHeight="100%;">
						<option value='' selected>--请选择--</option>
						<option value="01">一卡通充值</option>
						<option value="02">生活缴费</option>
						<option value="98">转账</option>
						<option value="99">账户充值</option>
					</select>
					</td>
					<th>内部交易状态:</th>
					<td>
						<select id="tranInStatusQuery"  name="tranInStatusQuery" class="easyui-combobox" panelHeight="auto" style="width: 180px;"  panelMaxHeight="75" editable="false" panelHeight="100%;">
							<option value='' selected>--请选择--</option>
					...
					<th>外部交易状态:</th>
					<td>
						<select id="tranOutStatusQuery" name="tranOutStatusQuery" class="easyui-combobox" panelHeight="auto" style="width: 180px;"  panelMaxHeight="75" editable="false" panelHeight="100%;">
							<option value='' selected>--请选择--</option>
	...
	<div id="traFlowTblToolbar" class="tableToolbar">
		<@sec.accessControl permission="transaction.flow.view">
			<a href="#" class="easyui-linkbutton" iconCls="icon-view" plain="true" id="viewTraFlow" onclick="viewTraFlow()">查看</a>
		</@sec.accessControl>
		<@sec.accessControl permission="transaction.flow.export">
