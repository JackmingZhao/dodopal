...
<head>
    ...
    <script type="text/javascript" src="../../js/product/buscardbusiness/icdcAcq.js"></script>
</head>
<body class="easyui-layout" style="overflow: hidden;">
	<div region="north" border="false" style="height:105px;overflow: hidden;">
	    <table id="queryCondition" class="viewtable">
	        <tr>
                ...
                <th></th>
                <td>
				<@sec.accessControl permission="buscardbusiness.icdcAcq.query">
			...
			<tr>
				...
				<th>可疑状态:</th>
                <td>
                	<select id="suspiciouStates" name="suspiciouStates" class="easyui-combobox" editable="false" panelHeight="90" style="width: 133px;">
						<option value='' selected>--请选择--</option>
	...
	<div id="icdcAcqTblToolbar" class="tableToolbar">
		<@sec.accessControl permission="buscardbusiness.icdcAcq.view">
		    <a href="#" class="easyui-linkbutton" iconCls="icon-view" plain="true" onclick="viewProductConsumeDetails();">查看</a>
		</@sec.accessControl>
		<@sec.accessControl permission="buscardbusiness.icdcAcq.export">
