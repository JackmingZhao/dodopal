package com.dodopal.payment.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.payment.business.*.*.*(..)) || execution(public * com.dodopal.payment.web.controller.*.*.*(..)) || execution(public * com.dodopal.payment.delegate.*.*.*(..))")
