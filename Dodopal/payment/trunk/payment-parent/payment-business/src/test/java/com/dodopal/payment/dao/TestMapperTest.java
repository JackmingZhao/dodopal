...
//
//import com.dodopal.payment.business.dao.TestMapper;
//
...
//        try {
//            com.dodopal.payment.business.model.Test test = new com.dodopal.payment.business.model.Test();
//            test.setName("123");
//            test.setAppName("payment");
//            test.setDescription("Junit test");
//            List<com.dodopal.payment.business.model.Test> testResult = testMapper.findTest(test);
//
//            if (testResult != null) {
//                System.out.println("##########################################");
...
//        try {
//            com.dodopal.payment.business.model.Test testResult = testMapper.findTestById("22");
//
//            System.out.println("##########################################");
//            System.out.println(ReflectionToStringBuilder.toString(testResult, ToStringStyle.MULTI_LINE_STYLE));
//            System.out.println("##########################################");
