package com.dodopal.portal.dao;
...
import com.dodopal.portal.business.dao.TestMapper;
...
public class TestMapperTest {
    ...
    public void testFindTest() {
        try {
            com.dodopal.portal.business.model.Test test = new com.dodopal.portal.business.model.Test();
            test.setName("123");
            test.setAppName("portal");
            test.setDescription("Junit test");
            List<com.dodopal.portal.business.model.Test> testResult = testMapper.findTest(test);

            if (testResult != null) {
                System.out.println("##########################################");
                System.out.println(ReflectionToStringBuilder.toString(testResult, ToStringStyle.MULTI_LINE_STYLE));
                System.out.println("##########################################");
                for (com.dodopal.portal.business.model.Test dp : testResult) {
                    System.out.println("##########################################");
    ...
    public void testFindTestById() {
        try {
            com.dodopal.portal.business.model.Test testResult = testMapper.findTestById("22");
