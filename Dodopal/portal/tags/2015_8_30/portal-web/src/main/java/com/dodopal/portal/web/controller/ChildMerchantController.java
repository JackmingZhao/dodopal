...
public class ChildMerchantController extends CommonController{
    ...
    */
    ...
    public @ResponseBody DodopalResponse<List<MerBusRateBean>> findProductList(HttpServletRequest request, @RequestBody String merCode) {
        ...
        try {
          ...
          response = childMerchantService.findProductList(merCode);
        }
        catch (Exception e) {
            e.printStackTrace();
            response.setCode(ResponseCode.UNKNOWN_ERROR);
