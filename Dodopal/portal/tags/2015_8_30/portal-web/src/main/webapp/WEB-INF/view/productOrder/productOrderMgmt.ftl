				...
				<form id="queryForm" action="#">
					<ul class="clearfix">
						<li class="w310"><span class="w100">订单创建时间：</span>
							<input name="startday" type="text" class="com-input-txt w74"  placeholder="起始时间" id="sdate" onfocus="c.showMoreDay = false;c.show(this,'');"/>
							-
							<input name="startday" type="text" class="com-input-txt w74"  placeholder="结束时间" id="sdate" onfocus="c.showMoreDay = false;c.show(this,'');"/>
						</li>
						<li>
