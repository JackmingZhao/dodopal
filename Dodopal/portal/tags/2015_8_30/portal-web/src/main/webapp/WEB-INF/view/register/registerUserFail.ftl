...
<div class="wd-main wd-main-min">
	<div class="container">
   		<div class="wd-reg-main">
        	<div class="wd-reg-up">				
                <h1 class="wd-reg-title"><div class="wd-icon wd-icon2"></div>很抱歉，注册失败！</h1>
                <p class="wd-reg-title"><span>${(DODOPAL_RESPONSE!"")}<span></p>
				<p><span id="seconds">3</span>秒后为您跳转至&nbsp;<a class="wd-orage1" href="${base}/register/registerPage"><strong>注册</strong></a>&nbsp;页面，请重新注册。</p>
            </div>
            <div class="wd-reg-down">
            	<p><strong>请返回&nbsp;<a class="wd-orage1" href="${base}/register/registerPage"><strong>注册</strong></a>&nbsp;页面重新注册！</strong>
                <br />您可以直接拨打&nbsp;<span>400-817-1000</span>&nbsp;寻求帮助。</p>
            </div>
        </div> 	
    </div>
</div>
