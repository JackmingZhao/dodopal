...
var calendar = {
    ...
    init: function (s) {
        ...
        _c.push("<div id='calendar_head' class='calendar_head'><em class='calendaremL'>&laquo;</em><input id='_calyear' type='text' value='" + currYea + "' /><input id='_calmod' type='text' value='" + currMon + "' /><em class='calendaremR'>&raquo;</em>");
        _c.push(_yers.join(""));
		...
		$('#_calendar').css({left: calLeft+"px",top:calTop +"px"});
		...
		$("#_tdCal tr:gt(0) td[date!='']").mouseout(function () { $(this).removeAttr("style") });
