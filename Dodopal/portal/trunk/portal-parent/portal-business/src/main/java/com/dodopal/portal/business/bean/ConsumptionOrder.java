...
public class ConsumptionOrder extends BaseEntity{
    ...
    public String getStatusStr() {
        String [] accounting = {"1000000001"};
        String [] success = {"1000000006","1000000007","1000000010","1000000012","1000000013"};
        String [] fail = {"1000000002","1000000003","1000000004","1000000008","1000000009","1000000011","1000000014","1000000015","1000000016"};        
        String [] suspicious = {"1000000005","1000000017","1000000018"};
        if(Arrays.asList(accounting).contains(status)){
            return "订单记账";
        }else if(Arrays.asList(success).contains(status)){
            return "成功订单";
