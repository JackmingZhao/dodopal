...
public class ConsumptionOrderCount extends BaseEntity{
    ...
    private ConsumptionOrderCount count;
    
    public ConsumptionOrderCount getCount() {
        return count;
    }
    public void setCount(ConsumptionOrderCount count) {
        this.count = count;
    }
