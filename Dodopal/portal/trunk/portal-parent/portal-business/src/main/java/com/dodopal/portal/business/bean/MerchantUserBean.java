...
public class MerchantUserBean extends BaseEntity implements Serializable {
	...
	private List<String> merUserRoleList;
	// 管辖部门列表名称
	private List<String> merGroupDeptNameList;
	/* 商户补充信息 2015年12月10日 15:37:51 *******/
	/* 学历 */
	...
	public String getMerUserIdentityTypeEdit() {
		return null != this.merUserIdentityType ? this.merUserIdentityType : "";
	}
	...
	public List<String> getMerUserRoleList() {
		return merUserRoleList;
	}

	public void setMerUserRoleList(List<String> merUserRoleList) {
	...
	public String getIncomeView() {
		if(this.income != null){ 
			return String.format("%.2f", Double.valueOf(this.income) / 100);
		}else{
			return "";
		}
	}
