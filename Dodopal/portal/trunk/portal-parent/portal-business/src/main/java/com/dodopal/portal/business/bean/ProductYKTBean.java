...
public class ProductYKTBean extends BaseEntity{

	private static final long serialVersionUID = 3813434369564066716L;
	...
	/**
	 * 一卡通支付费率类型  0:天数（表示每隔多少天结算一次。）、1：笔数（表示距离上一次结算点，支付业务达到多少笔之后开始新一次结算。）、2：金额（单位：元，表示距离上一次结算点，支付金额到达多少之后开始新一次结算。）
	 */
