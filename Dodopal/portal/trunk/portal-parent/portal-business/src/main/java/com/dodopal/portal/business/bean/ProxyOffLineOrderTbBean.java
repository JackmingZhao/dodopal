...
public class ProxyOffLineOrderTbBean extends BaseEntity{
    private static final long serialVersionUID = -444698966588720039L;
    ...
    private String proamt;//原有金额
    private String blackamt;//卡余额
