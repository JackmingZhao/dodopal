...
public class PurchaseOrderBean implements Serializable {
    private static final long serialVersionUID = 2502244578837843894L;
    ...
    public String getProOrderStateStr(){
        if(StringUtils.isNotBlank(proOrderState)){
            if(null!=ConsumeOrderStatesEnum.getConsumeOrderStatesEnumByCode(proOrderState))
                return ConsumeOrderStatesEnum.getConsumeOrderStatesEnumByCode(proOrderState).getName();
        }
        return null;
    }
}
