...
public class PosController extends CommonController{
     ...
     * @return
     */
    @RequestMapping("/findPosInfoByCode")
    public @ResponseBody DodopalResponse<PosBean> findPosInfoByCode(HttpServletRequest request, @RequestBody String posCode) {
    	DodopalResponse<PosBean> dodopalResponse = new DodopalResponse<PosBean>();
    	String merCode = super.getCurrentMerchantCode(request.getSession());
    	dodopalResponse = posService.findPosInfoByCode(posCode, merCode);
    	return dodopalResponse;
    }
     ...
     * @return
     */
    @RequestMapping("/savePosComments")
    public @ResponseBody DodopalResponse<String> savePosComments(HttpServletRequest request, @RequestBody PosBean posBean) {
    	String posCode = posBean.getCode();
    	String comments = posBean.getComments();
    	DodopalResponse<String> dodopalResponse = new DodopalResponse<String>();
    	dodopalResponse = posService.savePosComments(posCode, comments);
    	return dodopalResponse;
    }
