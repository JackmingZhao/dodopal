<div class="con-main" id="childMerchantDetailView"  style="display:none;">
	...
	<div class="com-bor-box com-bor-box01">
			...
			<table class="base-table base-table01" id="childMerchantViewTable">
				...
				<tr>
				 ...
				 <#if sessionUser.merType =='12'>
					<tr id="isAutoViewShow">
					  <th>是否自动分配：</th>
					  <td><span id="isAutoSpan"></span></td>
					</tr>
					
					<tr id="thresholdViewShow">
					  <th>额度阀值：</th>
					  <td><span id="thresholdSpan"></span></td>
					  <th>自动分配额度：</th>
					  <td><span id="limitSpan"></span></td>
					</tr>
					
				  <!--   <tr id="isAutoJoinViewShow">
					  <th>额度来源：</th>
					  <td><span id="isAutoJoinSpan"></span></td>
				   </tr> -->
				</#if>
				...
				<tr>
					...
					<tr>
						<th>业务类型：</th>
						<td><span id="PrdRateTypeSpan"></span></td>
					</tr>
				<tr>
					<th>通卡公司：</th>
			...
			<table class="base-table">
				...
				<tr>
					<th>学历：</th>
					<td ><span id="merUserEducationSpan"></span></td>
					<th>年收入(元)：</th>
					<td><span id="merUserIncomeSpan"></span></td>
				</tr>
					
				<tr>
					<th>生日：</th>
					<td ><span id="merUserBirthdaySpan"></span></td>
					<th>婚姻状况：</th>
					<td><span id="merUserMarStatusSpan"></span></td>
				</tr>
				<tr>
					<th>备注：</th>
