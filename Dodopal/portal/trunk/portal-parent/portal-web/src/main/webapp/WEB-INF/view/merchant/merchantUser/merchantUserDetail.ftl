			...
			<form id="detailForm" action="#">
				...
				<table class="base-table">
					...
					<tr>
						...
						<th>年收入：</th>
						<td>
							<input type="text" id="income" onclick='initMoney(this);' style="text-align: right;" class="com-input-txt w260" myPlaceholder="单位：元"  maxlength="60" />
					...
					<tr>
						<th>出生年月：</th>
						<td>
							<input type="text" id="birthday" class="com-input-txt w260" myPlaceholder="请选择生日"  readonly="readonly" onfocus="c.showMoreDay = false;c.timeOver=new Date();c.show(this,'');"  maxlength="20" />
				...
				<tr class="select-wd" >
                <th>省市：</th>
                <td id="addProCityLine">
                	<select name="provinceG" id="provinceG" onchange="checkProvinceG()"> </select>
					<select name="cityG" id="cityG"> </select>
					<div class="tip-error" id="addProCityVal"></div>
                </td>
                 <td id="editProCityLine"  style="display:none;">
                	<span  id="provinceView"> </span>
                	<span  id="cityView"> </span>
                </td>
                <th>详细地址：</th>
                <td><input type="text" class="com-input-txt w260" id="addressG" name="addressG" maxlength="200" oninput="checkAddressG()"/>
                <div class="tip-error" id="addressGVal"></div>
                </td>
                </tr>
					<tr>
						<th>备注：</th>
						<td>
							<textarea id="merUserRemark"   style="resize: none;"class="area-w268" maxlength="200" onkeydown="checkMaxlength(this,200);" onpropertychange="onmyinput(this)" oninput="return onmyinput(this)" onPaste="return onmypaste(this);" onKeyPress="return onmykeypress(this);"></textarea>
						</td>
						<th></th>
						<td></td>
					</tr>
