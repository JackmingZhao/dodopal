<div class="con-main" id="merchantUserDetailView"  style="display:none;">
	...
	<div class="com-bor-box com-bor-box01">
			...
			<table class="base-table">
				...
				<tr>
					<th>学历：</th>
					<td><span id="educationSpan"></span></td>
					<th>年收入：</th>
					<td><span id="incomeSpan"></span></td>
				</tr>
				<tr>
					<th>出生年月：</th>
					<td><span id="birthdaySpan"></span></td>
					<th>婚姻状况：</th>
					<td><span id="isMarriedSpan"></span></td>
				</tr>
				<tr>
					<th>省市：</th>
					<td><span id="merUserProNameSpan"></span>
					<span id="merUserCityNameSpan"></span></td>
					<th>详细地址：</th>
					<td><span id="merUserAddsSpan"></span></td>
				</tr>
