...
<div class="con-main" id="posManagerMainT"> <!-- InstanceBeginEditable name="main" -->
	...
	<div class="com-bor-box ">
		<ul class="navi-ul clearfix">
			...
			<@sec.accessControl permission="merchant.pos.modify">
			<li>
				<a href="javascript:toPosEdit();"  class="gray-btn-h22" id="posEditBtn">编辑</a>
			</li>
			</@sec.accessControl>
		</ul>
...
<div class="con-main" id="posManagerMainV" style="display: none;">
	<h3 class="tit-h3">POS管理</h3>
	<DIV class="com-bor-box com-bor-box1">
		<FORM>
			<TABLE class="base-table base-table01">
				...
				<tr>
					...
					<td id="codeV"></td>
					<th>绑定时间：</th>
					<td id="bundlingDateV"></td>
				</tr>
				<tr>
					<th>备注：</th>
					<td colspan="3" style="word-break:break-all">
						<INPUT TYPE="text" class="com-input-txt w260" maxlength="40" id="commentsV" ></INPUT>
					</td>
				</tr>
				<tr>
					<td colspan="4" class="a-center">
						<div class="btn-box">
							<input type="button" class="orange-btn-h32" id="savePosBtn"  value="保存" />
						 	<input type="button" value="取消" class="orange-btn-text32" id='cancPosBtn'  />
						</div>
					</td>
				</tr>
			</TABLE>
