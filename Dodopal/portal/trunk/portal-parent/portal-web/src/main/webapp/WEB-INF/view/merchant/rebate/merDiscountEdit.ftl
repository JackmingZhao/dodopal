...
<script type="text/javascript" src="${base}/js/merchant/rebate/merDiscountEdit.js"></script>
...
<div class="con-main"> <!-- InstanceBeginEditable name="main" -->
	<h3 class="tit-h3">编辑折扣</h3>
		<div class="com-bor-box com-bor-box01">
			<form action="/">
			<input type="hidden" name="merDiscountIdEdit" id="merDiscountIdEdit" value="${merDiscountIdEdit!}"></input>
			<input type="hidden" name="merName" id="merName" value="${merDiscountBean.merName!}"></input>
				<table class="base-table">
					<col width="160" />
					<tr>
						<th><span class="red">*</span>折扣：</th>
						<td><input type="text" id="discountEdit" class="com-input-txt w250" required="true" value="${merDiscountBean.discount!}" />&nbsp;折
					...
					<tr>
						...
						<td><ul class="ipt-list clearfix">
						  <#if merDiscountBean.activate =='0'>
								<li><label><input type="radio" name="a1" disabled="true" readOnly="true" checked="checked" value="0"/>启用</label></li>
								<li><label><input type="radio" name="a1" disabled="true" readOnly="true"  value="1" />停用</label></li>
						  <#else>
								<li><label><input type="radio" name="a1" disabled="true" readOnly="true"  value="0"/>启用</label></li>
								<li><label><input type="radio" name="a1" disabled="true" readOnly="true" checked="checked" value="1" />停用</label></li>
						  </#if>
							</ul>
							<div class="tip-error tip-red-error"></div></td>
					</tr>
						<th><span class="red">*</span>排序号：</th>
						<td><input type="text" id="sortEdit" class="com-input-txt w250" value="${merDiscountBean.sort!}" />
							<div class="tip-error tip-red-error"></div></td>
					</tr>
					 <#if merType =='12'>
					<tr>
						<th><span class="red">*</span>连锁直营网点：</th>
						<td><div class="input-box"><input type="text" id="collections" disabled="true" readOnly="true"  name="" class="com-input-txt w250" value="${merDiscountBean.merName!}"   /><a href="javascript:;" class="link-btn"></a></div><p class="notes-txt"><i></i>请选择网点名称</p></td>
					</tr>
					<#else>
					</#if>
                    <tr>
                    	<th></th>
						<td><div class="btn-box"><input type="button" class="orange-btn-h32" onclick="editDiscount()" value="保存" />
