    	...
    	<div class="tab-div">
        	<div class="tabs">
            	<ul class="tab-nav-s-1">
                	<li id="tabs-up" class=" wd-icon tab-nav-action" style="cursor:pointer;"><strong>个人用户</strong></li>
                    <li id="tabs-down" class=" wd-icon tab-nav" style="cursor:pointer;"><strong>商户用户</strong></li>
                </ul>
            </div>
            ...
            <div id="flag-1" class="flag">
              ...
              <tr>
                ...
                <td><div>
            		...
            		<p id="wd-fwtk">我已阅读并接受<a  href="../serviceAgreement" style="color: #37b4e9;" target="_blank">&nbsp;都都宝服务协议</a></p><span class="tips"  style="display:none;color: #ff0000;vertical-align:top;" id="registerUserStep1CheckValidation">请接受服务条款</span></div></td></tr>
            </table>
            </div>
            <div id="flag-2" class="flag" style="display:none">
               ...
               <table class="tab-table">
                ...
                <td  class="select-wid04">
                	<div>
                	<select name="provinceG" id="provinceG"> </select>
					<select name="cityG" id="cityG"> </select>
					<span class="tips" style="display:none;margin-left:5px;line-height: 2.3;color: #ff0000;" id="addressCityValidationG"></span>
					
					</div>
                </td></tr>
                <tr>
                <th>详细地址：</th>
                <td><div><input type="text" class="wd-input" id="addressG" name="addressG" maxlength="200"/><span class="tips" style="display:none;" id="addressTipsG">例如：XX市XX区XX街XX号XX室</span><span class="tips tip-error tip-red-error" style="display:none;" id="addressValidationG"></span></div></td></tr>
                <tr>
                <th></th>
        	...
        	<div  class="tabs-body">
               ...
               <table class="tab-table">
                ...
                <td><div>
            		...
            		<p id="wd-fwtk">我已阅读并接受<a  href="../serviceAgreement" class="wd-orage1" target="_blank">都都宝服务协议</a></p><span class="tips" style="display:none;color: #ff0000;vertical-align:top;" id="merRegisterStep1CheckValidation">请接受服务条款</span></div></td></tr>
            </table>
            </div>
