...
<script type="text/javascript" src="${base}/js/tranRecord/historyTran/merchant/rechargeOrderQuery.js" ></script>
		...
		<div class="seach-top-inner">
			<form action="/" id="queryForm">
				<ul class="clearfix">
					...
					<li class="btn-list">
						<input type="button" value="查询" class="orange-btn-h26" onclick="findChargeOrderList();" />
