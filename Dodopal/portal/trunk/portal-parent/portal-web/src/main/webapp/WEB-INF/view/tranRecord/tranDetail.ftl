...
<h3 class="tit-h3">交易详情</h3>
	<div class="com-bor-box com-bor-box01">
			...
			<ul class="times-info">
				...
				<li>备注：
				<#if payTraTransaction.comments??>
				${payTraTransaction.comments}
				<#else>
				&nbsp;
				</#if></li>
            </ul>
			...
			<tr>
               ...
               <!-- <td>
                	${((payTraTransaction.amountMoney)?number-(payTraTransaction.realTranMoney)?number)?string("currency")?substring(1)}
                	</td>-->
		...
		<div class="null-box"></div>
			...
			<div class="a-center btn-box"><a href="javascript:history.back();" class="orange-btn-h32">返回</a></div>
			</div>
