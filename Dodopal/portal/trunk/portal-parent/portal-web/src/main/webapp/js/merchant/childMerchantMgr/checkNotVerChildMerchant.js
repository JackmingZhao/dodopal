...
//额度阀值
function validateThresholdEditNotVer(state){
	return $.warnHandler(state,true,$.moneyPointTwo,"thresholdNotVerEdit","thresholdNotVerEditERR", "数字，整数6位，两位小数");
}

//额度
function validateLimitEditNotVer(state){
	return $.warnHandler(state,true,$.moneyPointTwo,"limitNotVerEdit","limitNotVerEditERR", "数字，整数6位，两位小数");
}

//收入
function validateMerUserIncomeNotVer(state){
	return $.warnHandler(state,false,$.moneyPointTwo,"merUserIncomeNotVer","merUserIncomeNotVerVal", "数字，整数6位，两位小数");
}
