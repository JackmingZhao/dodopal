...
//额度阀值
function validateThresholdEditVer(state){
	return $.warnHandler(state,true,$.moneyPointTwo,"thresholdEditVer","thresholdEditVerERR", "数字，整数6位，两位小数");
}

//额度
function validateLimitEditVer(state){
	return $.warnHandler(state,true,$.moneyPointTwo,"limitEditVer","limitEditVerERR", "数字，整数6位，两位小数");
}

//收入
function validateMerUserIncomeVer(state){
	return $.warnHandler(state,false,$.moneyPointTwo,"merUserIncomeVer","merUserIncomeVerVal", "数字，整数8位，两位小数");
}
