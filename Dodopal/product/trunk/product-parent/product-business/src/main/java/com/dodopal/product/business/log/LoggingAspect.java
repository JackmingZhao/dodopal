package com.dodopal.product.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.product.business.*.*.*(..)) || execution(public * com.dodopal.product.web.controller.*.*.*(..)) || execution(public * com.dodopal.product.delegate.*.*.*(..))")
