...
public class LoadOrderRecord extends BaseEntity {
    private static final long serialVersionUID = 1432892683485336075L;
    ...
    private String loadAmtView;

    private String customerPayAmtView;
    ...
    public String getStatus() {
        ...
        return LoadOrderStatusEnum.getLoadOrderStatusByCode(this.status).getName();
    }
    ...
    public String getLoadAmtView() {
        return loadAmtView;
    }

    public void setLoadAmtView(String loadAmtView) {
        this.loadAmtView = loadAmtView;
    }

    public String getCustomerPayAmtView() {
        return customerPayAmtView;
    }

    public void setCustomerPayAmtView(String customerPayAmtView) {
        this.customerPayAmtView = customerPayAmtView;
    }
