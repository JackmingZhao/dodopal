 ...
 *
 */
public class ProductConsumeOrderDetail extends BaseEntity{
    private static final long serialVersionUID = -8707035124110513275L;
  ...
  //备注
    ...
    public String getServiceRateType() {
        if(StringUtils.isBlank(this.serviceRateType)){
            return null;
        }else if(RateTypeEnum.getRateTypeByCode(this.serviceRateType)==null){
            return null;
        }
