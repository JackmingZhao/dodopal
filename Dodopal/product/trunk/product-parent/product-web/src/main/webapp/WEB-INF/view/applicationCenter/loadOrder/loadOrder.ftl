...
<title>一卡通圈存</title>
<#include "../../include.ftl"/>
<script src="${base}/js/applicationCenter/loadOrder/loadOrder.js" type="text/javascript"></script>
...
<div class="application-center clearfix">
	  <div class="app-right pr">
		 ...
		 <div class="app-pay-way quncun-tit">
			  <a href="${base}/loadOrder/toLoadOrder" class='blue current'>圈存订单</a><a href="${base}/loadOrder/loadOrderList" class="" style="padding-left:20px;">订单查询</a>
		  </div>
		  <dl class="app-dl clearfix com-bor-box com-bor-box01 app-dl-s pd2070">
              ...
              <dt>一卡通卡号：</dt>
			  <dd class="clearfix">
				  <input type="text" class="com-input-txt w260" id="cardNo" maxlength='20'/>
				  <i id="cardNoErr" style="display:none;" class="err">请输入您的一卡通卡号</i>
			  </dd>
			  <dt>再次输入卡号：</dt>
			  <dd class="clearfix">
				  <input type="text" class="com-input-txt w260" id="cardNoAga" maxlength='20'/>
				  <i id="cardNoAgaErr" style="display:none;" class="err">请再次输入一卡通卡号</i>
			  </dd>
			  <dt>支付金额：</dt>
			  <dd><i class="orange" id="realAmount">0</i> 元</dd>
			  <div id="payWayDiv">
			  <dt class="pt10">支付方式：</dt>
			  <dd>
				  <div class="pay-way">
				  ...
				  <dt></dt>
			  <dd class="btn-recharge"><a href="javascript:checkWarnDiv();"  class="orange-btn-h32" js="qurren">立即充值</a></dd>
		  </dl>
		  <dl class="app-dl02">
			  <dt>嘟卡攻略：</dt>
			  <dd>1、在整个充值过程中，请不要移动卡片；<br />
				  2、在显示充值结果前，请不要关闭、刷新或后退浏览器窗口；
<br />
