...
<div class="con-main">
<div style="margin:0 auto;width:490px;padding:40px 0px 120px 0px;">
	<div><img src="${styleUrl}/portal/css/images/404_2.png" />
    </div>
    <div style="padding:50px 0px 0px 160px; font-weight:bold;"><input type="button" onclick="closeWebPage();" class="orange-btn-h32" value="关闭此页" /></div> 
</div>
</div>
<#include "footLog.ftl"/>
</body>
