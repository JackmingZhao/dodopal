...
function getOCXMsgStr(bean,msg){
	if(parseInt(bean.code)!=000000){
		if(""==bean.message||null==bean.message){
			return msg+"<font size='2'>(错误码："+bean.code+")</font>";
		}else{
			return bean.message;
		}
	}else{
 ...
 * @returns 返回整数型字符串
 */
function getIntNumber(n){
	return (Number(n)*100).toFixed(0)+"";
}

//Number.prototype.getIntStr = function(){
//	  return getIntNumber(this);
//}