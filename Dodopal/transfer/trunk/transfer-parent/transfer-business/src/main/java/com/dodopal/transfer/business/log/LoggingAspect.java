package com.dodopal.transfer.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.transfer.business.*.*.*(..)) || execution(public * com.dodopal.transfer.web.controller.*.*.*(..)) || execution(public * com.dodopal.transfer.delegate.*.*.*(..))")
