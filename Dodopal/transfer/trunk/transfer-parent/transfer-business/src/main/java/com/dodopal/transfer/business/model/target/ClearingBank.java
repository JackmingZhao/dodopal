...
/**
 * The persistent class for the CLEARING_BANK database table.
 * 
 */
//@Entity
//@Table(name="CLEARING_BANK")
//@NamedQuery(name="ClearingBank.findAll", query="SELECT c FROM ClearingBank c")
public class ClearingBank implements Serializable {
