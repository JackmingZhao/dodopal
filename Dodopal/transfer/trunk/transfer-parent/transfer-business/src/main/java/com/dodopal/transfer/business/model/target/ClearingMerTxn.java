...
/**
 * The persistent class for the CLEARING_MER_TXN database table.
 * 
 */
//@Entity
//@Table(name="CLEARING_MER_TXN")
//@NamedQuery(name="ClearingMerTxn.findAll", query="SELECT c FROM ClearingMerTxn c")
public class ClearingMerTxn implements Serializable {
