...
/**
 * The persistent class for the CLEARING_YKT_CITY database table.
 * 
 */
//@Entity
//@Table(name="CLEARING_YKT_CITY")
//@NamedQuery(name="ClearingYktCity.findAll", query="SELECT c FROM ClearingYktCity c")
public class ClearingYktCity implements Serializable {
...
//	@Column(name="YKT_FEE")
	private BigDecimal yktFee;

//	@Column(name="YKT_NAME")
	private String yktName;

	public ClearingYktCity() {
	}
	...
	public BigDecimal getYktFee() {
		return this.yktFee;
	}

	public void setYktFee(BigDecimal yktFee) {
		this.yktFee = yktFee;
	}
