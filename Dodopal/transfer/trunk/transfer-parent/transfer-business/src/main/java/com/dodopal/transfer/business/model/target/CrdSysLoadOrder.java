...
/**
 * The persistent class for the CRD_SYS_LOAD_ORDER database table.
 * 
 */
//@Entity
//@Table(name="CRD_SYS_LOAD_ORDER")
//@NamedQuery(name="CrdSysLoadOrder.findAll", query="SELECT c FROM CrdSysLoadOrder c")
public class CrdSysLoadOrder implements Serializable {
...
//	@Column(name="CHARGE_CARD_NO")
	private String chargeCardNo;

//	@Column(name="CHARGE_CARD_POS_CODE")
	private String chargeCardPosCode;

//	@Temporal(TemporalType.DATE)
//	@Column(name="CHARGE_RES_CARD_DATE")
	private Date chargeResCardDate;

//	@Temporal(TemporalType.DATE)
//	@Column(name="CHARGE_SEND_CARD_DATE")
