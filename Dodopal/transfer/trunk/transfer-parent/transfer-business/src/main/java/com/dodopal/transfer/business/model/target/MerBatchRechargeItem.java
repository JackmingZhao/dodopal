...
/**
 * The persistent class for the MER_BATCH_RECHARGE_ITEM database table.
 * 
 */
//@Entity
//@Table(name="MER_BATCH_RECHARGE_ITEM")
//@NamedQuery(name="MerBatchRechargeItem.findAll", query="SELECT m FROM MerBatchRechargeItem m")
public class MerBatchRechargeItem implements Serializable {
