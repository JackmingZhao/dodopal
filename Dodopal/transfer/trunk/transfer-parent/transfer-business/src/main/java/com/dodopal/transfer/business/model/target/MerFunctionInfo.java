...
/**
 * The persistent class for the MER_FUNCTION_INFO database table.
 * 
 */
//@Entity
//@Table(name="MER_FUNCTION_INFO")
//@NamedQuery(name="MerFunctionInfo.findAll", query="SELECT m FROM MerFunctionInfo m")
public class MerFunctionInfo implements Serializable {
