...
/**
 * The persistent class for the MER_TYPE_FUN database table.
 * 
 */
//@Entity
//@Table(name="MER_TYPE_FUN")
//@NamedQuery(name="MerTypeFun.findAll", query="SELECT m FROM MerTypeFun m")
public class MerTypeFun implements Serializable {
