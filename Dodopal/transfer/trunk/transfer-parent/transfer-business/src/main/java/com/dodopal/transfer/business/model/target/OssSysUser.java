...
/**
 * The persistent class for the OSS_SYS_USER database table.
 * 
 */
//@Entity
//@Table(name="OSS_SYS_USER")
//@NamedQuery(name="OssSysUser.findAll", query="SELECT o FROM OssSysUser o")
public class OssSysUser implements Serializable {
