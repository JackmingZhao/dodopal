...
/**
 * The persistent class for the PAY_WAY_COMMON database table.
 * 
 */
//@Entity
//@Table(name="PAY_WAY_COMMON")
//@NamedQuery(name="PayWayCommon.findAll", query="SELECT p FROM PayWayCommon p")
public class PayWayCommon implements Serializable {
