...
/**
 * The persistent class for the PAY_WAY_EXTERNAL database table.
 * 
 */
//@Entity
//@Table(name="PAY_WAY_EXTERNAL")
//@NamedQuery(name="PayWayExternal.findAll", query="SELECT p FROM PayWayExternal p")
public class PayWayExternal implements Serializable {
