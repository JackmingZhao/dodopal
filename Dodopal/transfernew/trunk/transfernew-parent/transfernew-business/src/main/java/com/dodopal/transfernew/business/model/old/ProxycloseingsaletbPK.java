...
/**
 * The primary key class for the PROXYCLOSEINGSALETB database table.
 * 
 */
//@Embeddable
public class ProxycloseingsaletbPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof ProxycloseingsaletbPK)) {
			return false;
		}
		ProxycloseingsaletbPK castOther = (ProxycloseingsaletbPK)other;
		return 
