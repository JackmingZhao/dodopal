...
/**
 * The persistent class for the PROXYLIMITAPPLYFORAPPROVALTB database table.
 * 
 */
//@Entity
//@NamedQuery(name="Proxylimitapplyforapprovaltb.findAll", query="SELECT p FROM Proxylimitapplyforapprovaltb p")
public class Proxylimitapplyforapprovaltb implements Serializable {
...
//	@Id
	...
	public Proxylimitapplyforapprovaltb() {
	}
