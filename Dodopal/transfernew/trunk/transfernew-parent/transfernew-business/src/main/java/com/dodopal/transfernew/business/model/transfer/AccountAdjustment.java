...
/**
 * The persistent class for the ACCOUNT_ADJUSTMENT database table.
 * 
 */
//@Entity
//@Table(name="ACCOUNT_ADJUSTMENT")
//@NamedQuery(name="AccountAdjustment.findAll", query="SELECT a FROM AccountAdjustment a")
...
//	@Column(name="ACCOUNT_ADJUST_AMOUNT")
	private BigDecimal accountAdjustAmount;

//	@Temporal(TemporalType.DATE)
//	@Column(name="ACCOUNT_ADJUST_APPLY_DATE")
	private Date accountAdjustApplyDate;

//	@Column(name="ACCOUNT_ADJUST_APPLY_USER")
	private String accountAdjustApplyUser;

//	@Temporal(TemporalType.DATE)
//	@Column(name="ACCOUNT_ADJUST_AUDIT_DATE")
	private Date accountAdjustAuditDate;

//	@Column(name="ACCOUNT_ADJUST_AUDIT_EXPLAIN")
	private String accountAdjustAuditExplain;

//	@Column(name="ACCOUNT_ADJUST_AUDIT_USER")
	private String accountAdjustAuditUser;

//	@Column(name="ACCOUNT_ADJUST_CODE")
	private String accountAdjustCode;

//	@Column(name="ACCOUNT_ADJUST_REASON")
	private String accountAdjustReason;

//	@Column(name="ACCOUNT_ADJUST_STATE")
	private String accountAdjustState;

//	@Column(name="ACCOUNT_ADJUST_TYPE")
...
//	@Column(name="UPDATE_USER")
	...
	public BigDecimal getAccountAdjustAmount() {
		return this.accountAdjustAmount;
	}

	public void setAccountAdjustAmount(BigDecimal accountAdjustAmount) {
		this.accountAdjustAmount = accountAdjustAmount;
	}

	public Date getAccountAdjustApplyDate() {
		return this.accountAdjustApplyDate;
	}
	...
	public String getAccountAdjustApplyUser() {
		return this.accountAdjustApplyUser;
	}
	...
	public Date getAccountAdjustAuditDate() {
		return this.accountAdjustAuditDate;
	}
	...
	public String getAccountAdjustAuditExplain() {
		return this.accountAdjustAuditExplain;
	}
	...
	public String getAccountAdjustAuditUser() {
		return this.accountAdjustAuditUser;
	}
	...
	public String getAccountAdjustReason() {
		return this.accountAdjustReason;
	}
	...
	public String getAccountAdjustState() {
		return this.accountAdjustState;
	}
