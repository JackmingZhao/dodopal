...
/**
 * The persistent class for the CLEARING_YKT database table.
 * 
 */
//@Entity
//@Table(name="CLEARING_YKT")
//@NamedQuery(name="ClearingYkt.findAll", query="SELECT c FROM ClearingYkt c")
public class ClearingYkt implements Serializable {
