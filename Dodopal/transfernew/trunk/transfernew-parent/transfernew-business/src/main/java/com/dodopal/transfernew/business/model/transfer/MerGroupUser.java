...
/**
 * The persistent class for the MER_GROUP_USER database table.
 * 
 */
//@Entity
//@Table(name="MER_GROUP_USER")
//@NamedQuery(name="MerGroupUser.findAll", query="SELECT m FROM MerGroupUser m")
public class MerGroupUser implements Serializable {
