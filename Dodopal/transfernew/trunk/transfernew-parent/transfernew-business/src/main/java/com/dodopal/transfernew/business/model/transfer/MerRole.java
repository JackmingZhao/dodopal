...
/**
 * The persistent class for the MER_ROLE database table.
 * 
 */
//@Entity
//@Table(name="MER_ROLE")
//@NamedQuery(name="MerRole.findAll", query="SELECT m FROM MerRole m")
