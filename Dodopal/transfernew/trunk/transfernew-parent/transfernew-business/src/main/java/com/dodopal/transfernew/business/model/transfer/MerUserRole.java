...
/**
 * The persistent class for the MER_USER_ROLE database table.
 * 
 */
//@Entity
//@Table(name="MER_USER_ROLE")
//@NamedQuery(name="MerUserRole.findAll", query="SELECT m FROM MerUserRole m")
