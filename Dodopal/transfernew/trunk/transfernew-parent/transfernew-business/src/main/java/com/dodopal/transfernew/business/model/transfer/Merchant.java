...
public class Merchant implements Serializable {
	...
	// --------------------------------------------扩展信息
	// 商户扩展信息
	private MerchantExtend merExtend;
	// 用户信息(管理员)
	private MerchantUser merUser;
	// 用户信息(操作员)
	private List<MerchantUser> merUserList;
	// 商户补充信息
	...
	// 折扣信息
	private List<TranDiscount> tranDiscountList;
	// 商户折扣信息
	private List<MerchantTranDiscount> mtDiscountList;
	...
	public MerchantExtend getMerExtend() {
		return merExtend;
	}

	public void setMerExtend(MerchantExtend merExtend) {
		this.merExtend = merExtend;
	}

	public MerchantUser getMerUser() {
		return merUser;
	}

	public void setMerUser(MerchantUser merUser) {
	...
	public List<TranDiscount> getTranDiscountList() {
		return tranDiscountList;
	}

	public void setTranDiscountList(List<TranDiscount> tranDiscountList) {
		this.tranDiscountList = tranDiscountList;
	}

	public List<MerchantTranDiscount> getMtDiscountList() {
		return mtDiscountList;
	}

	public void setMtDiscountList(List<MerchantTranDiscount> mtDiscountList) {
		this.mtDiscountList = mtDiscountList;
	}

	public List<MerchantUser> getMerUserList() {
		return merUserList;
	}

	public void setMerUserList(List<MerchantUser> merUserList) {
		this.merUserList = merUserList;
	}
