...
// @NamedQuery(name="MerchantUser.findAll",
// query="SELECT m FROM MerchantUser m")
public class MerchantUser implements Serializable {
	...
	// --------------------------------------------扩展信息
	// 用户扩展信息
	private MerchantUserExtend merUserExtend;
	// 用户绑卡信息
	private List<MerUserCardBd> merUserCardBdList;
	// 优惠券信息
	private List<Tlcouponinfo> tlcouponinfoList;
	...
	public MerchantUserExtend getMerUserExtend() {
		return merUserExtend;
	}

	public void setMerUserExtend(MerchantUserExtend merUserExtend) {
		this.merUserExtend = merUserExtend;
	}

	public List<MerUserCardBd> getMerUserCardBdList() {
		return merUserCardBdList;
	}

	public void setMerUserCardBdList(List<MerUserCardBd> merUserCardBdList) {
		this.merUserCardBdList = merUserCardBdList;
	}

	public List<Tlcouponinfo> getTlcouponinfoList() {
		return tlcouponinfoList;
	}

	public void setTlcouponinfoList(List<Tlcouponinfo> tlcouponinfoList) {
		this.tlcouponinfoList = tlcouponinfoList;
	}
