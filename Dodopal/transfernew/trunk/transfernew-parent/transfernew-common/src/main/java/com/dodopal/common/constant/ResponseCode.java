...
public class ResponseCode {
    ...
    public static final String OSS_POS_BATCH_UPLOAD_OVER_MAXSIZE = "100033"; //文件大小超出限制

    public static final String OSS_POS_BATCH_UPLOAD_INCORRECT_FILE = "100034"; //文件格式不正确

    public static final String OSS_POS_BATCH_UPLOAD_FILE_EMPTY = "100035"; //文件为空

    public static final String OSS_POS_BATCH_UPDATE_ERROR = "100036"; //POS文件批处理出错

    public static final String OSS_POS_BATCH_UPLOAD_FILE_PART_SUCCESS = "100037"; //文件导入部分成功
