...
public class MerchantUserDTO extends BaseEntity implements Serializable {

	private static final long serialVersionUID = 5951361112539981354L;
	...
	private List<MerRoleDTO> merUserRoleList;
	...
	//---- 新增用户表字段 Time:2016-01-13 Name:Joe
	/* 用户所属省份 */
...
//      if(this.merUserSex.equals("0")){
//            return "男";
//        }else if(this.merUserSex.equals("1")){
//            return "女";
//            
//        }
//        return null;
