package com.dodopal.users.business.log;
...
public class LoggingAspect {
    ...
    @Pointcut("execution(public * com.dodopal.users.business.*.*.*(..)) || execution(public * com.dodopal.users.web.controller.*.*.*(..)) || execution(public * com.dodopal.users.delegate.*.*.*(..))")
