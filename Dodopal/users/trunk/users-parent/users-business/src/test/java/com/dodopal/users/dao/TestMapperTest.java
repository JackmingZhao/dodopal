...
public class TestMapperTest {
    ...
    public void testFindTest() {
        try {
            ...
            test.setName("123");
            test.setAppName("users");
            test.setDescription("Junit test");
            List<com.dodopal.users.business.model.Test> testResult = testMapper.findTest(test);
    ...
    public void testFindTestById() {
        try {
            com.dodopal.users.business.model.Test testResult = testMapper.findTestById("22");
