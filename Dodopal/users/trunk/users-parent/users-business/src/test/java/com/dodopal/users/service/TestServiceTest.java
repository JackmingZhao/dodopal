...
//    @Test
    public void testFindTest() {
        try {
            com.dodopal.users.business.model.Test test = new com.dodopal.users.business.model.Test();
            test.setName("test");
            List<com.dodopal.users.business.model.Test> testResult = testService.findTest(test);

            if (testResult != null) {
                System.out.println("##########################################");
                System.out.println(ReflectionToStringBuilder.toString(testResult, ToStringStyle.MULTI_LINE_STYLE));
                System.out.println("##########################################");
                for (com.dodopal.users.business.model.Test dp : testResult) {
                    System.out.println("##########################################");
...
//    @Test
    public void testFindTestById() {
        try {
            com.dodopal.users.business.model.Test testResult = testService.findTestById("62E88C94D0E042839993E60995B15A6A");
